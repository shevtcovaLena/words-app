...
│   │   ├── auth/              # Страницы и логика аутентификации
...
│   │   │   └── actions.ts     # Server Actions для авторизации
│   │   ├── admin/             # Админка (доступна только администраторам)
│   │   │   ├── page.tsx       # Главная страница админа
│   │   │   ├── groups/        # Управление группами слов
│   │   │   │   └── [groupId]/
│   │   │   ├── actions.ts      # Server Actions для управления словами
│   │   │   └── group-actions.ts # Server Actions для управления группами
│   │   ├── words/             # Тренировка слов для авторизованных пользователей
...
│   │   │   ├── add-word-form.tsx
│   │   │   ├── group-manager.tsx
│   │   │   ├── group-words-manager.tsx
│   │   │   ├── words-list.tsx
│   │   │   ├── photo-upload.tsx
│   │   │   └── word-mask-editor.tsx
│   │   ├── words/             # Компоненты для тренировки слов
│   │   │   ├── words-practice.tsx # Основной интерфейс практики
│   │   │   ├── word-practice.tsx  # Компонент отдельного слова
│   │   │   └── game-complete.tsx  # Экран завершения игры
│   │   ├── ocr/               # Компоненты для OCR
...
│   │   ├── groups-list.tsx    # Список групп слов
...
│   │   └── useGetMessage.ts
│   ├── lib/                   # Основные библиотеки и бизнес-логика
│   │   ├── game.ts            # Логика игры и управление сессией
│   │   ├── words.ts           # Работа со словами
│   │   ├── storage.ts         # Локальное хранилище
│   │   ├── ocr.ts             # OCR функциональность
...
- Роль-базированный доступ:
  - **Admin**: доступ к админ-панели (`/admin`) для управления словами и группами
  - **User**: доступ к тренировке слов (`/words`) с отслеживанием прогресса
- Дополнительная информация для авторизованных пользователей (статистика, прогресс)
...
- Готовая конфигурация для unit-тестов компонентов
